...
package MyGroupIdSpringJpa.MyArtifactIdSpringJpa
...
import MyGroupIdSpringJpa.MyArtifactIdSpringJpa.reader.mycomponent.MyStreamReaderImpl
import MyGroupIdSpringJpa.MyArtifactIdSpringJpa.transformer.mycomponent.MyStreamTransformerImpl
import MyGroupIdSpringJpa.MyArtifactIdSpringJpa.writer.mycomponent.MyStreamWriterImpl
